...
var DetailsTable = function DetailsTable(_ref13) {
  var expandButtonTitle = _ref13.expandButtonTitle,
      ...
      rows = _ref13.rows,
      size = _ref13.size,
      props = _objectWithoutPropertiesLoose(_ref13, ["expandButtonTitle", "labelTextTransform", "labelFontSize", "labelWidth", "justifyBetween", "rows", "size"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Wrapper$2, props, rows.filter(function (row) {
  ...
  }), showExpandButton && /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(OutlineButton, {
    color: "secondary",
    ...
    size: "xs",
    mb: 4
  }, expandButtonTitle), expanded && rows.filter(function (row) {
    return row.expandable;
  }).map(function (row) {
    return renderRow(row);
  })));
...
var ReactSelectWrapper = styled__default['default'].div(_templateObject$F(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.text.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledRow = styled__default['default'].div(_templateObject$G(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
}, function (_ref2) {
  var show = _ref2.show;
...
var StyledLabel$3 = styled__default['default'](FormLabel)(_templateObject2$d(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.breakpoints.down("sm");
}, function (_ref6) {
  var theme = _ref6.theme;
...
var Wrapper$7 = styled__default['default'].div(_templateObject$H(), function (_ref) {
  var size = _ref.size;
...
var StyledSwitchContainer = styled__default['default'].div(_templateObject$I(), function (_ref2) {
  var theme = _ref2.theme,
...
var StyledSwitch = styled__default['default'].span(_templateObject2$e(), function (_ref9) {
  var theme = _ref9.theme;
  return theme.palette.gray.medium;
}, function (_ref10) {
  var theme = _ref10.theme,
...
var StyledToggle = styled__default['default'].div(_templateObject$J(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var ItemConnector = styled__default['default'].div(_templateObject$K(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.regular;
});
var Container$3 = styled__default['default'].div(_templateObject2$f(), ItemConnector);
...
var Container$4 = styled__default['default'].div(_templateObject$L(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledImg = styled__default['default'].img(_templateObject$M(), function (_ref2) {
...
var StyledIndicator = styled__default['default'].div(_templateObject$N(), function (_ref) {
  var color = _ref.color,
      theme = _ref.theme;
...
})(_templateObject$O(), function (_ref) {
  var theme = _ref.theme;
...
var Content$3 = styled__default['default'].div(_templateObject2$h(), function (_ref) {
  var theme = _ref.theme;
...
})(_templateObject2$i(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.breakpoints.down("sm");
});
...
var NestedListItem = styled__default['default'](core.ListItem)(_templateObject$R(), function (_ref) {
  var theme = _ref.theme;
...
var ImprovedListItem = styled__default['default'](core.ListItem)(_templateObject2$j(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.palette.text.secondary;
}, function (_ref5) {
  var theme = _ref5.theme;
...
var MainNav = styled__default['default'].div(_templateObject$S(), function (_ref) {
  var theme = _ref.theme;
...
})(_templateObject2$k(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.spacing(4);
}, function (_ref3) {
  var theme = _ref3.theme;
...
var StyledFooter = styled__default['default'].div(_templateObject$T(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var Content$4 = styled__default['default'].div(_templateObject2$l());
...
var StyledFooter$1 = styled__default['default'].div(_templateObject$V(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
})(_templateObject$W(), function (_ref) {
  var theme = _ref.theme;
  return theme.breakpoints.down("md");
});
...
var LicenseBoxWrapper = styled__default['default'].div(_templateObject$Y(), function (_ref) {
  var theme = _ref.theme;
...
var StyledIcon$3 = styled__default['default'](Icon)(_templateObject2$n(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.spacing(6);
});
...
var StyledMarketPlaceItem = styled__default['default'](BoxBase)(_templateObject$Z(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(10);
});
var Content$6 = styled__default['default'].div(_templateObject2$o(), function (_ref2) {
  var theme = _ref2.theme;
...
var Wrapper$8 = styled__default['default'].div(_templateObject$_());
var BGImage = styled__default['default'].div(_templateObject2$p(), function (_ref) {
...
var StyledMarketPlaceItem$1 = styled__default['default'](BoxBase)(_templateObject$$(), function (_ref) {
  var hoverEffect = _ref.hoverEffect;
  return hoverEffect && styled.css(["&:hover{transform:scale(1.03);}"]);
});
var Content$7 = styled__default['default'].div(_templateObject2$q(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.spacing(4);
});
...
var Wrapper$9 = styled__default['default'].div(_templateObject$10());
var BGImage$1 = styled__default['default'].div(_templateObject2$r(), function (_ref) {
  var imgSrc = _ref.imgSrc;
  return imgSrc;
});
...
var StyledMarketPlaceItem$2 = styled__default['default'](BoxBase)(_templateObject$11(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (_ref2) {
...
})(_templateObject2$s(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.spacing(4);
});
...
})(_templateObject2$t(), function (_ref) {
  var theme = _ref.theme;
...
var Wrapper$a = styled__default['default'].div(_templateObject$13(), function (theme) {
  return COLOR(theme);
}, function (theme) {
  return DISPLAY(theme);
}, function (theme) {
...
var StyledLoading = styled__default['default'].div(_templateObject$14(), function (_ref) {
  var type = _ref.type;
...
var StyledBar = styled__default['default'].div(_templateObject$15(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.primary.main;
});
var InnerBar = styled__default['default'].div(_templateObject2$v(), function (_ref2) {
  var theme = _ref2.theme;
...
var StyledContent = styled__default['default'].div(_templateObject$16(), function (_ref) {
...
var StyledPagination = styled__default['default'](MuiPagination__default['default'])(_templateObject$17());
var StyledPaginationItem = styled__default['default'](PaginationItem__default['default'])(_templateObject2$w(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
});
...
var StyledSearchBar = styled__default['default'].form(_templateObject$18(), function (_ref) {
  var noBorderRadius = _ref.noBorderRadius;
...
var Button$1 = styled__default['default'](ButtonBase)(_templateObject$19(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$6 = styled__default['default'].div(_templateObject$1a(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var ButtonsWrapper = styled__default['default'].div(_templateObject2$y(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var Wrapper$b = styled__default['default'].div(_templateObject$1d(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (theme) {
  return SPACER(theme);
...
var StyledTabs = styled__default['default'](MuiTabs__default['default'])(_templateObject2$z(), function (_ref2) {
  var theme = _ref2.theme;
...
var Row$2 = styled__default['default'].tr(_templateObject$1e(), function (_ref) {
  var size = _ref.size;
...
var StyledTable = styled__default['default'].table(_templateObject$1i());
...
var StyledImage$2 = styled__default['default'](Image)(_templateObject2$A());
...
var StyledImg$1 = styled__default['default'](Image)(_templateObject2$B());
...
var Container$7 = styled__default['default'].div(_templateObject$1l(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
}, function (theme) {
  return SPACER(theme);
...
var IconWrapper = styled__default['default'].div(_templateObject2$C());
...
var StyledContent$1 = styled__default['default'].div(_templateObject$1n());
var ActionWrapper = styled__default['default'].div(_templateObject2$D());
...
var Flag = styled__default['default'].div(_templateObject2$E(), function (props) {
...
var Wrapper$c = styled__default['default'].div(_templateObject$1p(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var StepsWrapper = styled__default['default'].div(_templateObject2$F(), function (_ref) {
