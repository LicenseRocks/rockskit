...
var StyledMessage = styled__default.div(_templateObject$2(), function (_ref) {
  ...
  var noBorderRadius = _ref3.noBorderRadius;
...
var Alert = function Alert(_ref7) {
  var content = _ref7.content,
      ...
      props = _objectWithoutPropertiesLoose(_ref7, ["content", "children"]);
...
var BoxHeader = function BoxHeader(_ref4) {
  var action = _ref4.action,
      ...
      props = _objectWithoutPropertiesLoose(_ref4, ["action", "actionIcon", "actionIconSize", "renderAction", "renderTitle", "subTitle", "subTitleColor", "title", "titleIcon", "titleSize"]);
...
var StyledDivider = styled__default.hr(_templateObject$i(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
...
var StyledDropdown = styled__default(Menu)(_templateObject$j(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var Wrapper$2 = styled__default.div(_templateObject$k(), function (_ref) {
  var theme = _ref.theme;
...
var Container = styled__default.div(_templateObject$l(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$1 = styled__default.div(_templateObject$m());
...
var StyledInput = styled__default.input(_templateObject$n(), function (_ref) {
...
var StyledRadioBase = styled__default(RadioBase)(_templateObject$o(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var Error = styled__default.div(_templateObject$p(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.error.main;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledWrapper = styled__default.div(_templateObject$q(), function (_ref) {
  var theme = _ref.theme;
...
}))(_templateObject$r(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.palette.text.primary;
}, function (_ref3) {
...
var StyledFieldset = styled__default.fieldset(_templateObject$s());
...
var Item$1 = styled__default.div(_templateObject$t(), function (_ref) {
  var theme = _ref.theme;
...
var StyledContainer = styled__default.div(_templateObject$u(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledLabel$2 = styled__default.label(_templateObject$v(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.medium;
});
...
var StyledRadioBase$1 = styled__default(RadioBase)(_templateObject$w(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var ReactSelectWrapper = styled__default.div(_templateObject$x(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.text.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledRow = styled__default.div(_templateObject$y(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
}, function (_ref2) {
  var show = _ref2.show;
...
var StyledLabel$3 = styled__default(FormLabel)(_templateObject2$8(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.spacing(3);
}, function (_ref5) {
  var theme = _ref5.theme;
...
var Wrapper$4 = styled__default.div(_templateObject$z(), function (_ref) {
  var size = _ref.size;
...
var StyledSwitchContainer = styled__default.div(_templateObject$A(), function (_ref2) {
  var theme = _ref2.theme,
...
var StyledToggle = styled__default.div(_templateObject$B(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var ItemConnector = styled__default.div(_templateObject$C(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.regular;
});
...
var Container$3 = styled__default.div(_templateObject$D(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledImg = styled__default.img(_templateObject$E(), function (_ref2) {
...
var StyledContainer$1 = styled__default(MuiContainer)(_templateObject$G());
...
var NestedListItem = styled__default(core.ListItem)(_templateObject$I(), function (_ref) {
  var theme = _ref.theme;
...
var ImprovedListItem = styled__default(core.ListItem)(_templateObject2$e(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.palette.text.secondary;
}, function (_ref5) {
  var theme = _ref5.theme;
...
var ImprovedList = styled__default(core.List)(_templateObject3$5());
...
var NavigationMenu = function NavigationMenu(_ref12) {
  ...
  return /*#__PURE__*/React__default.createElement(ImprovedList, {
    ...
    var nestedListItem = function nestedListItem(_ref14) {
      ...
      return WrapperComponent ? /*#__PURE__*/React__default.createElement(WrapperComponent, null, item()) : nestedItem(nested);
    };
...
var MainNav = styled__default.div(_templateObject$J(), function (_ref) {
  var theme = _ref.theme;
...
var StyledFooter = styled__default.div(_templateObject$K(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var Content$2 = styled__default.div(_templateObject2$g());
...
})(_templateObject3$7(), function (_ref) {
  var theme = _ref.theme;
...
var StyledFooter$1 = styled__default.div(_templateObject$M(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
})(_templateObject$N(), function (_ref) {
  var theme = _ref.theme;
  return theme.breakpoints.down("md");
});
...
var ButtonsWrapper = styled__default.div(_templateObject2$j(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
})(_templateObject3$9(), function (_ref2) {
...
var StyledTabs = styled__default(MuiTabs)(_templateObject2$k(), function (_ref2) {
  var theme = _ref2.theme;
...
var StyledTab = styled__default(MuiTab)(_templateObject3$a());
...
var ErrorWrapper = styled__default.div(_templateObject$W());
var StyledImage = styled__default(Image)(_templateObject2$l());
...
var StyledImg$1 = styled__default(Image)(_templateObject2$m());
...
var IconWrapper = styled__default.div(_templateObject2$n());
var StyledIcon$2 = styled__default(Icon)(_templateObject3$b(), function (_ref2) {
  var color = _ref2.color,
      theme = _ref2.theme;
...
var ActionWrapper = styled__default.div(_templateObject2$o());
var StepHint = styled__default.span(_templateObject3$c(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.palette.gray.medium;
});
var duration$1 = 500;
...
var Flag = styled__default.div(_templateObject2$p(), function (props) {
...
var Label$1 = styled__default.span(_templateObject3$d(), function (props) {
...
var StepsWrapper = styled__default.div(_templateObject2$q(), function (_ref) {
...
var Steps = styled__default.div(_templateObject3$e(), function (_ref2) {
  var isHorizontal = _ref2.isHorizontal;
