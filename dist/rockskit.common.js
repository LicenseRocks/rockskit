...
var Squared = styled__default.div(_templateObject2(), function (_ref2) {
  var color = _ref2.color,
      theme = _ref2.theme;
  return styled.css(["width:40px;height:40px;border:solid 1px ", ";background-color:transparent;display:inline-flex;align-items:center;justify-content:center;border-radius:8px;box-sizing:border-box;position:relative;"], theme.palette[color].light);
});
...
var Icon = function Icon(_ref7) {
  var className = _ref7.className,
      color = _ref7.color,
      rounded = _ref7.rounded,
      squared = _ref7.squared,
      prefix = _ref7.prefix,
      props = _objectWithoutPropertiesLoose(_ref7, ["className", "color", "rounded", "squared", "prefix"]);
...
var BoxHeader = function BoxHeader(_ref4) {
  var action = _ref4.action,
      ...
      props = _objectWithoutPropertiesLoose(_ref4, ["action", "actionIcon", "actionIconSize", "renderAction", "renderTitle", "metaTitle", "metaTitleColor", "subTitle", "subTitleColor", "title", "titleIcon", "titleSize"]);

  return /*#__PURE__*/React__default.createElement(StyledBoxHeader, props, /*#__PURE__*/React__default.createElement(Flex, {
    item: true
  }, renderTitle() || /*#__PURE__*/React__default.createElement(Flex, {
    container: true
  }, titleIcon && /*#__PURE__*/React__default.createElement(Icon, {
    colorBlack: true,
    icon: titleIcon,
    mr: 2,
    size: "lg"
  }), /*#__PURE__*/React__default.createElement("div", null, metaTitle && /*#__PURE__*/React__default.createElement(Text, {
    content: metaTitle,
...
var Box = function Box(_ref2) {
  var alert = _ref2.alert,
      ...
      props = _objectWithoutPropertiesLoose(_ref2, ["alert", "alertColor", "children", "footerAction", "footerActionLoading", "footerActionDisabled", "footerActionTitle", "footerActionType", "footerRenderAction", "footerRenderTitle", "headerAction", "headerActionIcon", "headerActionIconSize", "headerMetaTitle", "headerMetaTitleColor", "headerRenderAction", "headerRenderTitle", "headerSubTitle", "headerSubTitleColor", "headerTitle", "headerTitleIcon", "headerTitleSize", "padding", "transition"]);
...
var StyledLoading = styled__default.div(_templateObject$T(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
});
...
var StyledContent = styled__default.div(_templateObject$U(), function (_ref) {
...
var StyledSearchBar = styled__default.form(_templateObject$V(), function (_ref) {
  var noBorderRadius = _ref.noBorderRadius;
...
var Button$1 = styled__default(ButtonBase)(_templateObject$W(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$4 = styled__default.div(_templateObject$X(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var ButtonsWrapper = styled__default.div(_templateObject2$n(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var StyledDotsSpinner = styled__default.div(_templateObject$Y(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var StyledRocksSpinner = styled__default.div(_templateObject$Z(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var Wrapper$5 = styled__default.div(_templateObject$_(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (theme) {
  return SPACER(theme);
...
var StyledTabs = styled__default(MuiTabs)(_templateObject2$o(), function (_ref2) {
  var theme = _ref2.theme;
...
var Tab = function Tab(_ref4) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Wrapper$5, props, /*#__PURE__*/React__default.createElement(StyledTabs, {
    value: currentTab,
...
var ErrorWrapper = styled__default.div(_templateObject$$(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
});
var StyledImage = styled__default(Image)(_templateObject2$p());
...
var StyledImg$1 = styled__default(Image)(_templateObject2$q());
...
var Container$5 = styled__default.div(_templateObject$11(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
}, function (theme) {
  return SPACER(theme);
...
var IconWrapper = styled__default.div(_templateObject2$r());
var StyledIcon$4 = styled__default(Icon)(_templateObject3$e(), function (_ref2) {
  var color = _ref2.color,
      theme = _ref2.theme;
...
var Thumbnail = function Thumbnail(_ref3) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Container$5, _extends({
    onClick: handleClick
  }, props), loadError ? /*#__PURE__*/React__default.createElement(StyledIcon$4, {
    color: "secondary",
    icon: "file",
    size: "lg"
  }) : /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(IconWrapper, null, /*#__PURE__*/React__default.createElement(StyledIcon$4, {
    icon: "search-plus"
...
var StyledContent$1 = styled__default.div(_templateObject$12(), function (_ref) {
  var duration = _ref.duration;
  return duration / 2;
}, function (_ref2) {
  var state = _ref2.state;
...
var ActionWrapper = styled__default.div(_templateObject2$s());
...
var StyledTitle = styled__default.div(_templateObject$13(), function (_ref) {
...
var Flag = styled__default.div(_templateObject2$t(), function (props) {
...
var Wrapper$6 = styled__default.div(_templateObject$14(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var StepsWrapper = styled__default.div(_templateObject2$u(), function (_ref) {
...
var Wizard = function Wizard(_ref7) {
  ...
  return /*#__PURE__*/React__default.createElement(Wrapper$6, props, /*#__PURE__*/React__default.createElement(StepsWrapper, {
    isHorizontal: isHorizontal
