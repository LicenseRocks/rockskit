import React, { forwardRef, useState, useEffect, Fragment, useRef, createRef } from 'react';
...
var Squared = styled.div(_templateObject2(), function (_ref2) {
  var color = _ref2.color,
      theme = _ref2.theme;
  return css(["width:40px;height:40px;border:solid 1px ", ";background-color:transparent;display:inline-flex;align-items:center;justify-content:center;border-radius:8px;box-sizing:border-box;position:relative;"], theme.palette[color].light);
});
...
var BoxHeader = function BoxHeader(_ref4) {
  ...
  return /*#__PURE__*/React.createElement(StyledBoxHeader, props, /*#__PURE__*/React.createElement(Flex, {
    ...
    mr: 2,
    size: "lg"
  }), /*#__PURE__*/React.createElement("div", null, metaTitle && /*#__PURE__*/React.createElement(Text, {
    content: metaTitle,
...
var StyledWrapper = styled.div(_templateObject$r(), function (_ref) {
  ...
  return hasError && css(["border:1px solid ", ";"], function (_ref7) {
    var theme = _ref7.theme;
    return theme.palette.error.main;
  });
}, function (_ref8) {
...
var RemoveIcon = styled(Icon)(_templateObject2$7(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.palette.common.white;
});
...
var StyledContainer = styled.div(_templateObject$v(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var DropzoneArea = styled.div(_templateObject2$8(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledLabel$2 = styled.label(_templateObject$w(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.medium;
});
...
var StyledRadioBase$1 = styled(RadioBase)(_templateObject$x(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var ReactSelectWrapper = styled.div(_templateObject$y(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.text.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledRow = styled.div(_templateObject$z(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
}, function (_ref2) {
  var show = _ref2.show;
...
var StyledLabel$3 = styled(FormLabel)(_templateObject2$9(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.spacing(3);
}, function (_ref5) {
  var theme = _ref5.theme;
...
var FieldsAndErrorsWrapper = styled.div(_templateObject3$4());
...
var Wrapper$4 = styled.div(_templateObject$A(), function (_ref) {
  var size = _ref.size;
...
var StyledSwitchContainer = styled.div(_templateObject$B(), function (_ref2) {
  var theme = _ref2.theme,
...
var StyledSwitch = styled.span(_templateObject2$a(), function (_ref9) {
  var theme = _ref9.theme;
  return theme.palette.gray.medium;
}, function (_ref10) {
  var theme = _ref10.theme,
...
var StyledToggle = styled.div(_templateObject$C(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var ItemConnector = styled.div(_templateObject$D(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.regular;
});
var Container$2 = styled.div(_templateObject2$b(), ItemConnector);
var RowWrapper = styled.div(_templateObject3$5());
...
var Container$3 = styled.div(_templateObject$E(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledImg = styled.img(_templateObject$F(), function (_ref2) {
...
var StyledContainer$1 = styled(MuiContainer)(_templateObject$H());
var Content$1 = styled.div(_templateObject2$d(), function (_ref) {
  var theme = _ref.theme;
...
var NestedListItem = styled(ListItem)(_templateObject$J(), function (_ref) {
  var theme = _ref.theme;
...
var ImprovedListItem = styled(ListItem)(_templateObject2$f(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.palette.text.secondary;
}, function (_ref5) {
  var theme = _ref5.theme;
...
var ImprovedList = styled(List)(_templateObject3$7());
...
var MainNav = styled.div(_templateObject$K(), function (_ref) {
  var theme = _ref.theme;
...
var StyledFooter = styled.div(_templateObject$L(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var Content$2 = styled.div(_templateObject2$h());
...
var StyledFooter$1 = styled.div(_templateObject$N(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var LicenseBoxWrapper = styled.div(_templateObject$Q(), function (_ref) {
  var theme = _ref.theme;
...
var StyledIcon$3 = styled(Icon)(_templateObject2$j(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.spacing(6);
});
...
var StyledMarketPlaceItem = styled(BoxBase)(_templateObject$R(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(10);
});
var Content$4 = styled.div(_templateObject2$k(), function (_ref2) {
  var theme = _ref2.theme;
...
var StyledLoading = styled.div(_templateObject$T(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
});
...
var StyledContent = styled.div(_templateObject$U(), function (_ref) {
...
var StyledSearchBar = styled.form(_templateObject$V(), function (_ref) {
  var noBorderRadius = _ref.noBorderRadius;
...
var FilterButton = styled(TextButton)(_templateObject3$b(), function (_ref3) {
  var theme = _ref3.theme;
...
var Button$1 = styled(ButtonBase)(_templateObject$W(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$4 = styled.div(_templateObject$X(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledDotsSpinner = styled.div(_templateObject$Y(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var StyledRocksSpinner = styled.div(_templateObject$Z(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var Wrapper$5 = styled.div(_templateObject$_(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (theme) {
  return SPACER(theme);
...
var StyledTabs = styled(MuiTabs)(_templateObject2$o(), function (_ref2) {
  var theme = _ref2.theme;
...
var StyledTab = styled(MuiTab)(_templateObject3$d());
var Tab = function Tab(_ref4) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Wrapper$5, props, /*#__PURE__*/React.createElement(StyledTabs, {
    value: currentTab,
...
var ErrorWrapper = styled.div(_templateObject$$(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
});
var StyledImage = styled(Image)(_templateObject2$p());
...
var StyledImg$1 = styled(Image)(_templateObject2$q());
...
var Container$5 = styled.div(_templateObject$11(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
}, function (theme) {
  return SPACER(theme);
...
var IconWrapper = styled.div(_templateObject2$r());
var StyledIcon$4 = styled(Icon)(_templateObject3$e(), function (_ref2) {
  var color = _ref2.color,
      theme = _ref2.theme;
...
var Thumbnail = function Thumbnail(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Container$5, _extends({
    onClick: handleClick
  }, props), loadError ? /*#__PURE__*/React.createElement(StyledIcon$4, {
    color: "secondary",
    icon: "file",
    size: "lg"
  }) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(IconWrapper, null, /*#__PURE__*/React.createElement(StyledIcon$4, {
    icon: "search-plus"
...
var StyledContent$1 = styled.div(_templateObject$12(), function (_ref) {
  var duration = _ref.duration;
  return duration / 2;
}, function (_ref2) {
  var state = _ref2.state;
...
var ActionWrapper = styled.div(_templateObject2$s());
var StepHint = styled.span(_templateObject3$f(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.palette.gray.medium;
});
var duration$1 = 500;
...
var StyledTitle = styled.div(_templateObject$13(), function (_ref) {
...
var Flag = styled.div(_templateObject2$t(), function (props) {
...
var Wrapper$6 = styled.div(_templateObject$14(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var StepsWrapper = styled.div(_templateObject2$u(), function (_ref) {
...
var Wizard = function Wizard(_ref7) {
  ...
  return /*#__PURE__*/React.createElement(Wrapper$6, props, /*#__PURE__*/React.createElement(StepsWrapper, {
    isHorizontal: isHorizontal
