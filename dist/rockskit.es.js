...
var StyledBox = styled.div(_templateObject$g(), function (_ref) {
  ...
  var transparentSm = _ref3.transparentSm,
      theme = _ref3.theme;
  return transparentSm && css(["", "{box-shadow:none;background-color:transparent;}"], theme.breakpoints.down("sm"));
}, function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
...
var Wrapper = styled.div(_templateObject$i(), function (_ref) {
  ...
  var transparentSm = _ref3.transparentSm,
      theme = _ref3.theme;
  return transparentSm && css(["", "{background-color:transparent;}"], theme.breakpoints.down("sm"));
});
...
var Content$1 = styled.div(_templateObject3$2(), function (_ref7) {
  ...
  var transparentSm = _ref8.transparentSm,
      theme = _ref8.theme;
  return transparentSm && css(["", "{padding:0;}"], theme.breakpoints.down("sm"));
});
...
var StyledHidden = styled(MuiHidden)(_templateObject$M(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var ItemConnector = styled.div(_templateObject$N(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.regular;
});
...
var Container$4 = styled.div(_templateObject$O(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledImg = styled.img(_templateObject$P(), function (_ref2) {
...
var StyledIndicator = styled.div(_templateObject$Q(), function (_ref) {
  var color = _ref.color,
      theme = _ref.theme;
...
var Footer = styled.div(_templateObject$T(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledHeader$1 = styled.div(_templateObject$U(), function (_ref) {
  var theme = _ref.theme;
...
var StyledHeader$2 = styled.div(_templateObject$V(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledDrawer = styled(Drawer)(_templateObject$W(), function (_ref) {
...
var Header = styled.div(_templateObject$X(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var CreatorsHubAuthLayout = function CreatorsHubAuthLayout(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, loading && /*#__PURE__*/React.createElement(PageLoading, {
    fullScreen: true
  }), /*#__PURE__*/React.createElement(StyledContainer$2, props, /*#__PURE__*/React.createElement(CreatorsHubHeader, headerProps), /*#__PURE__*/React.createElement(InnerContainer, null, /*#__PURE__*/React.createElement(Content$4, null, children))));
};
...
var NestedListItem = styled(ListItem$1)(_templateObject$$(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.text.secondary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var MainNav = styled.div(_templateObject$10(), function (_ref) {
  var theme = _ref.theme;
...
var StyledFooter = styled.div(_templateObject$11(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var StyledFooter$1 = styled.div(_templateObject$13(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var LicenseBoxWrapper = styled.div(_templateObject$16(), function (_ref) {
  var theme = _ref.theme;
...
var StyledMarketPlaceItem = styled(BoxBase)(_templateObject$17(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(10);
});
...
var StyledImage = styled(Image)(_templateObject$18());
...
var StyledMarketPlaceItem$1 = styled(BoxBase)(_templateObject$19(), function (_ref) {
...
var Wrapper$8 = styled.div(_templateObject$1a());
...
var StyledMarketPlaceItem$2 = styled(BoxBase)(_templateObject$1b(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (_ref2) {
...
var Wrapper$9 = styled.div(_templateObject$1d(), function (theme) {
  return COLOR(theme);
}, function (theme) {
  return DISPLAY(theme);
}, function (theme) {
...
var StyledLoading = styled.div(_templateObject$1e(), function (_ref) {
...
var StyledBar = styled.div(_templateObject$1f(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.primary.main;
});
...
var StyledContent = styled.div(_templateObject$1g(), function (_ref) {
...
var StyledPagination = styled(MuiPagination)(_templateObject$1h());
...
var StyledSearchBar = styled.form(_templateObject$1i(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var Button$1 = styled(ButtonBase)(_templateObject$1j(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$7 = styled.div(_templateObject$1k(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledDotsSpinner = styled.div(_templateObject$1l(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var StyledRocksSpinner = styled.div(_templateObject$1m(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var Wrapper$a = styled.div(_templateObject$1n(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (theme) {
  return SPACER(theme);
...
var Row$2 = styled.tr(_templateObject$1o(), function (_ref) {
  var size = _ref.size;
...
var StyledTd = styled.td(_templateObject$1p(), function (_ref) {
...
var StyledThead = styled.thead(_templateObject$1q(), function (_ref) {
...
var StyledTr = styled.tr(_templateObject$1r(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
});
...
var StyledTable = styled.table(_templateObject$1s(), function (_ref) {
  var theme = _ref.theme;
  return theme.breakpoints.down("sm");
});
...
var Table = function Table(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(StyledTable, props, /*#__PURE__*/React.createElement(Heading, {
    columns: columns,
    hasData: rows.length > 0
  }), /*#__PURE__*/React.createElement(StyledTbody, null, rows.length > 0 ? /*#__PURE__*/React.createElement(Rows, {
    columns: columns,
    rows: rows,
    rowsBottomBorderSm: rowsBottomBorderSm,
    rowsSize: rowsSize
...
var ErrorWrapper = styled.div(_templateObject$1t(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
});
...
var Container$8 = styled.div(_templateObject$1v(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
}, function (theme) {
  return SPACER(theme);
...
var StyledContent$1 = styled.div(_templateObject$1x(), function (_ref) {
  var theme = _ref.theme;
  return theme.breakpoints.down("sm");
});
...
var StyledTitle = styled.div(_templateObject$1y(), function (_ref) {
...
var Wrapper$b = styled.div(_templateObject$1z(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
