...
var StyledBadge = styled.div(_templateObject$7(), function (_ref) {
  var color = _ref.color,
      theme = _ref.theme;
...
var StyledBox = styled.div(_templateObject$8(), function (_ref) {
  var theme = _ref.theme;
...
var StyledFlex = styled(Grid)(_templateObject$9(), function (theme) {
...
var BoxContent = styled.div(_templateObject$c(), function (_ref) {
...
var StyledButton = styled(MuiButtonBase)(_templateObject$d(), function (_ref) {
...
var StyledButton$1 = styled(ButtonBase)(_templateObject$e(), function (_ref) {
...
var StyledButton$2 = styled(ButtonBase)(_templateObject$f(), function (_ref) {
  var colors = _ref.colors;
...
var StyledButton$3 = styled(ButtonBase)(_templateObject$g(), function (_ref) {
  var colors = _ref.colors;
...
var StyledCategoryItem = styled.div(_templateObject$h(), function (_ref) {
  var theme = _ref.theme;
...
var Wrapper = styled.div(_templateObject$i());
...
var Wrapper$1 = styled.div(_templateObject$j(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledDivider = styled.hr(_templateObject$k(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
...
var StyledDropdown = styled(Menu)(_templateObject$l(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var Wrapper$2 = styled.div(_templateObject$m(), function (_ref) {
  var theme = _ref.theme;
...
var Container = styled.div(_templateObject$n(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$1 = styled.div(_templateObject$o());
...
var StyledInput = styled.input(_templateObject$p(), function (_ref) {
...
var StyledLabel$1 = styled.label(_templateObject2$6(), function (_ref12) {
...
var Wrapper$4 = styled.div(_templateObject$q(), function (_ref) {
...
var StyledRadioBase = styled(RadioBase)(_templateObject$r(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var Error = styled.div(_templateObject$s(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.error.main;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledWrapper = styled.div(_templateObject$t(), function (_ref) {
  var theme = _ref.theme;
...
var StyledFieldset = styled.fieldset(_templateObject$v());
...
var Item$1 = styled.div(_templateObject$w(), function (_ref) {
  var theme = _ref.theme;
...
var Wrapper$5 = styled.div(_templateObject$x());
...
var StyledContainer = styled.div(_templateObject$y(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledLabel$2 = styled.label(_templateObject$z(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.medium;
});
...
var StyledRadioBase$1 = styled(RadioBase)(_templateObject$A(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var ReactSelectWrapper = styled.div(_templateObject$B(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.text.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledRow = styled.div(_templateObject$C(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
}, function (_ref2) {
  var show = _ref2.show;
...
var StyledLabel$3 = styled(FormLabel)(_templateObject2$a(), function (_ref5) {
  var theme = _ref5.theme;
  return theme.breakpoints.down("sm");
}, function (_ref6) {
  var theme = _ref6.theme;
...
var Wrapper$6 = styled.div(_templateObject$D(), function (_ref) {
  var size = _ref.size;
...
var StyledSwitchContainer = styled.div(_templateObject$E(), function (_ref2) {
  var theme = _ref2.theme,
...
var StyledToggle = styled.div(_templateObject$F(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var ItemConnector = styled.div(_templateObject$G(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.regular;
});
...
var Container$4 = styled.div(_templateObject$H(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var StyledImg = styled.img(_templateObject$I(), function (_ref2) {
...
var NestedListItem = styled(ListItem)(_templateObject$M(), function (_ref) {
  var theme = _ref.theme;
...
var ImprovedList = styled(List)(_templateObject3$9());
...
var MainNav = styled.div(_templateObject$N(), function (_ref) {
  var theme = _ref.theme;
...
var StyledFooter = styled.div(_templateObject$O(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var StyledFooter$1 = styled.div(_templateObject$Q(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var LicenseBoxWrapper = styled.div(_templateObject$T(), function (_ref) {
  var theme = _ref.theme;
...
var StyledMarketPlaceItem = styled(BoxBase)(_templateObject$U(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(10);
});
...
var Wrapper$7 = styled.div(_templateObject$V());
var BGImage = styled.div(_templateObject2$m(), function (_ref) {
  var imgSrc = _ref.imgSrc;
  return imgSrc;
});
var StyledImage = styled(Image)(_templateObject3$c());
...
var StyledMarketPlaceItem$1 = styled(BoxBase)(_templateObject$W(), function (_ref) {
...
var Badges = styled.div(_templateObject3$d(), function (_ref3) {
  var theme = _ref3.theme;
  return theme.spacing(4);
});
...
var ModernItem = function ModernItem(_ref5) {
  ...
  var Item = function Item() {
    return /*#__PURE__*/React.createElement(StyledMarketPlaceItem$1, _extends({
      ...
      fontWeight: "bold",
      fontSize: "sm"
    })), /*#__PURE__*/React.createElement(Content$5, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(H3, {
      content: title,
      noWrap: true
    }), /*#__PURE__*/React.createElement(Text, {
      content: megaTitle,
...
var Wrapper$8 = styled.div(_templateObject$X());
var BGImage$1 = styled.div(_templateObject2$o(), function (_ref) {
  var imgSrc = _ref.imgSrc;
  return imgSrc;
});
var StyledImage$1 = styled(Image)(_templateObject3$e());
...
var StyledMarketPlaceItem$2 = styled(BoxBase)(_templateObject$Y(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (_ref2) {
...
var Highlight$1 = styled.div(_templateObject3$f(), function (_ref4) {
  var theme = _ref4.theme;
  return theme.palette.primary.light;
}, function (_ref5) {
  var theme = _ref5.theme;
...
var ModernHorizontalItem = function ModernHorizontalItem(_ref6) {
  ...
  var Item = function Item() {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(StyledMarketPlaceItem$2, _extends({
      ...
      imgSrc: coverSrc,
      placeholderSrc: coverPlaceholderSrc
    }), /*#__PURE__*/React.createElement(Content$6, null, /*#__PURE__*/React.createElement(Flex, {
      item: true,
      xs: 12,
      md: 7,
      lg: 8,
...
var Wrapper$9 = styled.div(_templateObject$_(), function (theme) {
  return COLOR(theme);
}, function (theme) {
  return DISPLAY(theme);
}, function (theme) {
...
var StyledLoading = styled.div(_templateObject$$(), function (_ref) {
  var type = _ref.type;
...
var StyledBar = styled.div(_templateObject$10(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.primary.main;
});
var InnerBar = styled.div(_templateObject2$s(), function (_ref2) {
  var theme = _ref2.theme;
...
var StyledContent = styled.div(_templateObject$11(), function (_ref) {
...
var StyledPagination = styled(MuiPagination)(_templateObject$12());
var StyledPaginationItem = styled(PaginationItem)(_templateObject2$t(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
});
...
var StyledSearchBar = styled.form(_templateObject$13(), function (_ref) {
  var noBorderRadius = _ref.noBorderRadius;
...
var FilterButton = styled(TextButton)(_templateObject3$h(), function (_ref3) {
  var theme = _ref3.theme;
...
var Button$1 = styled(ButtonBase)(_templateObject$14(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$6 = styled.div(_templateObject$15(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var ButtonsWrapper = styled.div(_templateObject2$v(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var StyledDotsSpinner = styled.div(_templateObject$16(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var StyledRocksSpinner = styled.div(_templateObject$17(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var Wrapper$a = styled.div(_templateObject$18(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (theme) {
  return SPACER(theme);
...
var StyledTabs = styled(MuiTabs)(_templateObject2$w(), function (_ref2) {
  var theme = _ref2.theme;
...
var StyledTab = styled(MuiTab)(_templateObject3$j());
...
var ErrorWrapper = styled.div(_templateObject$19(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
});
var StyledImage$2 = styled(Image)(_templateObject2$x());
...
var StyledImg$1 = styled(Image)(_templateObject2$y());
...
var Container$7 = styled.div(_templateObject$1b(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
}, function (theme) {
  return SPACER(theme);
...
var IconWrapper = styled.div(_templateObject2$z());
var StyledIcon$5 = styled(Icon)(_templateObject3$k(), function (_ref2) {
  var color = _ref2.color,
      theme = _ref2.theme;
...
var StyledContent$1 = styled.div(_templateObject$1c());
var ActionWrapper = styled.div(_templateObject2$A());
...
var Flag = styled.div(_templateObject2$B(), function (props) {
...
var Label$1 = styled.span(_templateObject3$l(), function (props) {
...
var Wrapper$b = styled.div(_templateObject$1e(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var StepsWrapper = styled.div(_templateObject2$C(), function (_ref) {
...
var Steps = styled.div(_templateObject3$m(), function (_ref2) {
  var isHorizontal = _ref2.isHorizontal;
...
var StepConnector = styled.div(_templateObject4$8(), function (props) {
  return stepBorderAndTitleColor(props);
}, function (_ref3) {
  var transitionDuration = _ref3.transitionDuration;
  return transitionDuration + "ms";
