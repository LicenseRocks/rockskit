...
var Wrapper$5 = styled.div(_templateObject$T(), function (theme) {
  return COLOR(theme);
}, function (theme) {
  return DISPLAY(theme);
}, function (theme) {
...
var NoItem = function NoItem(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Wrapper$5, _extends({
    "data-cy": dataCy
...
var StyledLoading = styled.div(_templateObject$U(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
});
...
var StyledBar = styled.div(_templateObject$V(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.primary.main;
});
var InnerBar = styled.div(_templateObject2$n(), function (_ref2) {
  var theme = _ref2.theme;
...
var StyledContent = styled.div(_templateObject$W(), function (_ref) {
...
var StyledPagination = styled(MuiPagination)(_templateObject$X());
var StyledPaginationItem = styled(PaginationItem)(_templateObject2$o(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
});
...
var StyledSearchBar = styled.form(_templateObject$Y(), function (_ref) {
  var noBorderRadius = _ref.noBorderRadius;
...
var Button$1 = styled(ButtonBase)(_templateObject$Z(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.gray.semiLight;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var Container$5 = styled.div(_templateObject$_(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
var ButtonsWrapper = styled.div(_templateObject2$q(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(2);
});
...
var ShareModule = function ShareModule(_ref3) {
  ...
  var theme = useTheme();
  return /*#__PURE__*/React.createElement(Container$5, props, /*#__PURE__*/React.createElement(ButtonsWrapper, null, shareOptions.includes("twitter") && /*#__PURE__*/React.createElement(ShareModuleButton, {
    icon: "twitter",
...
var StyledDotsSpinner = styled.div(_templateObject$$(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var StyledRocksSpinner = styled.div(_templateObject$10(), function (_ref) {
  var size = _ref.size;
  return size;
}, function (_ref2) {
  var size = _ref2.size;
...
var Wrapper$6 = styled.div(_templateObject$11(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
}, function (theme) {
  return SPACER(theme);
...
var StyledTabs = styled(MuiTabs)(_templateObject2$r(), function (_ref2) {
  var theme = _ref2.theme;
...
var ErrorWrapper = styled.div(_templateObject$12(), function (_ref) {
  var theme = _ref.theme;
  return theme.spacing(4);
});
var StyledImage = styled(Image)(_templateObject2$s());
...
var Container$6 = styled.div(_templateObject$14(), function (_ref) {
  var theme = _ref.theme;
  return theme.palette.common.white;
}, function (theme) {
  return SPACER(theme);
...
var IconWrapper = styled.div(_templateObject2$u());
var StyledIcon$5 = styled(Icon)(_templateObject3$e(), function (_ref2) {
  var color = _ref2.color,
      theme = _ref2.theme;
...
var Thumbnail = function Thumbnail(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Container$6, _extends({
    onClick: handleClick
...
var StyledContent$1 = styled.div(_templateObject$15());
var ActionWrapper = styled.div(_templateObject2$v());
...
var StyledTitle = styled.div(_templateObject$16(), function (_ref) {
...
var Label$1 = styled.span(_templateObject3$f(), function (props) {
...
var Wrapper$7 = styled.div(_templateObject$17(), function (theme) {
  return SPACER(theme);
}, function (theme) {
  return DISPLAY(theme);
});
...
var Steps = styled.div(_templateObject3$g(), function (_ref2) {
  var isHorizontal = _ref2.isHorizontal;
